export const enUS = {
  ...
  auth: {
    ...
    password: 'Password',
    passwordPlaceholder: '••••••••',
    passwordHint: 'Use at least 8 characters with upper/lowercase and a number.',
    createAccount: 'Create Account',
    needAccount: 'Need an account? Register',
    haveAccount: 'Already have an account? Sign in',
    submitting: 'Submitting...',
    registrationSuccess: 'Account created. Please sign in.',
  ...
  attendance: {
    ...
    qrCodeLabel: 'QR Code',
    qrCodePlaceholder: 'Paste or scan QR code',
    notes: 'Notes',
    notesPlaceholder: 'Optional notes...',
    submitScan: 'Submit Scan',
    scanning: 'Scanning...',
    qrCodeRequired: 'Enter a QR code to continue.',
    ...
    registrationSuccess: 'Registration saved successfully.',
