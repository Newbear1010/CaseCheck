export const zhTW = {
  ...
  auth: {
    ...
    phone: '電話',
    phonePlaceholder: '選填電話',
    department: '部門',
    departmentPlaceholder: '例如：營運',
    password: '密碼',
    passwordPlaceholder: '••••••••',
    passwordHint: '至少 8 碼，需含大小寫字母與數字。',
    createAccount: '建立帳號',
    needAccount: '需要帳號？註冊',
    haveAccount: '已有帳號？登入',
    submitting: '送出中...',
    registrationSuccess: '帳號已建立，請登入。',
  ...
  attendance: {
    ...
    retryScan: '重試掃描',
    qrCodeLabel: 'QR Code',
    qrCodePlaceholder: '貼上或掃描 QR Code',
    notes: '備註',
    notesPlaceholder: '選填備註...',
    submitScan: '送出掃描',
    scanning: '掃描中...',
    qrCodeRequired: '請輸入 QR Code。',
    ...
    noActivities: '沒有可用的活動。',
    totalRegistered: '總登記人數',
    attendanceRate: '出席率',
    checkedIn: '已簽到',
    checkedOut: '已簽退',
    unknownLocation: '未知',
