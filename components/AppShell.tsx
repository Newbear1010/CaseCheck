        ...
        <div className="flex flex-col h-full">
          <div className="p-6">
            <div className="flex items-center space-x-3 text-blue-400 mb-8">
              <ShieldCheck size={32} />
              <span className="text-xl font-bold tracking-tight">CASE FLOW</span>
            </div>
            
            <nav className="space-y-1">
              <NavItem icon={LayoutDashboard} label="Dashboard" id="dashboard" />
              <NavItem icon={ClipboardList} label="Activities" id="activities" />
              <NavItem icon={PlusSquare} label="New Activity" id="create" action="activity:edit" />
              <NavItem icon={ShieldCheck} label="Approval Center" id="approvals" action="activity:approve" />
              <NavItem icon={FileText} label="System Reports" id="reports" action="admin:policy_manage" />
            </nav>
          </div>
        ...
        <header className="h-16 bg-white border-b border-slate-200 flex items-center justify-between px-6 sticky top-0 z-30">
          <div className="flex items-center space-x-4">
            <div className="relative">
              ...
              <input 
                type="text" 
                placeholder="Search Cases, IDs, Members..." 
          ...
          <div className="flex items-center space-x-6">
            ...
            <div className="flex items-center space-x-3 border-l pl-6 border-slate-200">
              <div className="text-right hidden sm:block">
                ...
                <div className="text-xs text-slate-500">{user.role} | {user.department}</div>
              </div>
